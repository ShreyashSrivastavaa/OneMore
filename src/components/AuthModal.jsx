  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-pop">
      <div className={`relative w-full max-w-md rounded-3xl border p-6 sm:p-8 space-y-5 shadow-2xl ${
        ...
        {currentSaved ? (
          <div className="space-y-4 pt-2 text-center animate-pop">
            <div className={`p-6 rounded-2xl border flex flex-col items-center gap-3 ${
              isDark ? 'bg-black/60 border-white/15' : 'bg-slate-50 border-slate-200'
            }`}>
              <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-[#00E664] to-[#e2ff00] text-black font-black text-2xl flex items-center justify-center shadow-lg font-mono">
                {currentSaved.charAt(0).toUpperCase()}
              </div>
              <div>
                <div className="text-xl font-black font-sans text-[#00E664]">@{currentSaved.toUpperCase()}</div>
                <div className="text-xs font-mono text-slate-400 mt-1 flex items-center justify-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-[#00E664] animate-pulse" />
                  <span>Authenticated Player Session</span>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-3.5 px-6 rounded-2xl border border-red-500/50 bg-red-500/10 hover:bg-red-500/20 text-red-400 font-mono text-sm font-black uppercase tracking-wider flex items-center justify-center gap-2 transition-all cursor-pointer active:scale-95 shadow-md"
            >
